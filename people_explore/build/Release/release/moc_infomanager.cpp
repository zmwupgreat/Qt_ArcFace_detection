...
QT_MOC_LITERAL(1, 12, 16), // "onbtnexitClicked"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 19) // "onmodelindexClicked"

    },
    "InFoManager\0onbtnexitClicked\0\0"
    "onmodelindexClicked"
};
...
void InFoManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        InFoManager *_t = static_cast<InFoManager *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject InFoManager::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_InFoManager.data,
      qt_meta_data_InFoManager,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *InFoManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_InFoManager.stringdata0))
        return static_cast<void*>(const_cast< InFoManager*>(this));
